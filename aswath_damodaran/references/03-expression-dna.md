# Aswath Damodaran - Expression DNA
...
Damodaran constantly emphasizes that "every valuation is a story about the future."
...
While Graham and Buffett talk about margin of safety as a price discount, Damodaran frames it as understanding uncertainty.
...
Damodaran writes in a way that is both rigorous and understandable.

**Characteristics:**
- Clear definitions of key terms
- Use of analogies from everyday life
...
3. Here's how to apply it
4. Here's the limitation

### Use of Analogies

**Market as a Voting Machine:**
> "In the short run, the market is a voting machine. In the long run, it is a weighing machine. Most investors spend too much time watching the voting and not enough time on the weighing."
...
Damodaran's lectures are known for being engaging and interactive.

**Characteristics:**
- Socratic questioning
- Real-world examples
- Humor mixed with serious content
...
- "What could go wrong?"
- "How would this play out in the worst case?"
...
## Phrases That Define His Voice

**On Valuation:**
- "Every valuation is a story about the future"
- "The number is not the valuation"
- "Garbage in, garbage out"
- "Simple beats complex when fundamentals are uncertain"
...
Damodaran's phrases have become part of the valuation lexicon:
- "Every valuation is a story about the future"
- "The number is not the valuation"
